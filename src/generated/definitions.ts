...
/** definition for bountytaskline */
export interface Bountytaskline {
  /** level */
  level: number;
  /** xp */
  xp: number;
...
/** definition for mmg_output */
export interface MmgOutput {
  /** item */
  item: string;
  /** qty_per_hour */
  qty_per_hour: number;
